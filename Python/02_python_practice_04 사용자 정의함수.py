# -*- coding: utf-8 -*-
"""
Created on Wed Dec 15 15:22:54 2021
...
# 예제 : 숫자를 넣을 거예요, 여기에 10을 곱한 값을 리턴하세요

f1 = lambda x: x*10
f1(5)

#문제
# 3개 숫자를 전달 받아 첫 번째와 두번째 합에 세번 째 숫자의 곱 리턴
...
f1(4)
map(f1, l1)
# Out[126]: <map at 0x26972e399d0>
list(map(f1, l1))

# 연습
# 하나의 숫자를 전달받을거예요. 10보타 크면 3 을 곱하고, 
